...
Available in stable **0.16.2**; it was introduced and first verified in RC2, and its runtime behavior is unchanged by the later compatibility and migration patches. See the [current release notes](../releases/v0.16.2.md), the [0.16.1 notes](../releases/v0.16.1.md), and the [RC2 notes](../releases/v0.16.0-rc.2.md) for the respective verification scopes.
